...
<div class="container-fluid" id="container-fluid">
    <form action="${abs}/controller" method="post">
        ...
        <br/><br/>
        First name: <input type="first_name" id="first_name" class="form-control" required pattern="([А-Я]{1}[а-яё]{1,23}|[A-Z]{1}[a-z]{1,23})" name="first_name" >
        <c:choose>
        ...
        <br/><br/>
        Last name: <input type="last_name" id="last_name" class="form-control"  required pattern="([А-Я]{1}[а-яё]{1,30}|[A-Z]{1}[a-z]{1,30})" name="last_name">
        <c:choose>
        ...
        <br/><br/>
        Address: <input type="address" id="address" class="form-control" required pattern="([А-Я]{1}[а-яё]{1,23}|[A-Z]{1}[a-z]{1,23})(\s)(\d{1,3})\-(\d{1,3})" name="address">
        <c:choose>
