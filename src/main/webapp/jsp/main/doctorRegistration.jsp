...
<div class="container-fluid" id="container-fluid">
    <form action="${abs}/controller" method="post">
        ...
        category: <input type="category" id="category" class="form-control" name="category" value="${valid_categoty}">
        <c:choose>
        ...
        experience: <input type="experience" id="experience" class="form-control" name="experience" value="${valid_experience}">
        <c:choose>
        ...
        speciality: <input type="speciality" id="speciality" class="form-control" name="speciality" value="${valid_speciality}">
        <c:choose>
