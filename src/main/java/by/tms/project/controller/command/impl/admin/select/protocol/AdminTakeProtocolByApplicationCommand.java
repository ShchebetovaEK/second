...
public class AdminTakeProtocolByApplicationCommand implements Command {
    ...
    public Router execute(HttpServletRequest request) throws CommandException {
        ...
        String protocolApplication = request.getParameter(RequestParameter.PROTOCOL_APPLICATION);
        try {
            List<Protocol> protocolList = protocolService.findByApplication(Application.valueOf(protocolApplication.toUpperCase()));
